...
def execute_cmd(cmd_str, execute=False):
    """Execute or output (execute==False) command string.
    """
    if execute:
...
def run_command(pwd, home, rc, cad_file, job_id, num_cores=12, execute=False):
