...
// Kernel generated
int kern_degrid_gpu_16(const double _scale, const int32_t _grid_size, buffer_t *_gcf_buffer, buffer_t *_uvg_buffer, buffer_t *_vis_buffer, buffer_t *_vis_out_buffer);
int kern_degrid_gpu_32(const double _scale, const int32_t _grid_size, buffer_t *_gcf_buffer, buffer_t *_uvg_buffer, buffer_t *_vis_buffer, buffer_t *_vis_out_buffer);
int kern_degrid_gpu_64(const double _scale, const int32_t _grid_size, buffer_t *_gcf_buffer, buffer_t *_uvg_buffer, buffer_t *_vis_buffer, buffer_t *_vis_out_buffer);
...
int kern_degrid_gpu1(const double _scale, const int32_t _grid_size, buffer_t *_gcf_buffer, buffer_t *_uvg_buffer, buffer_t *_vis_buffer, buffer_t *_vis_out_buffer){
  ...
  #define __I_CASE(siz) case siz: res = kern_degrid_gpu_ ## siz (_scale, _grid_size, _gcf_buffer, _uvg_buffer, _vis_buffer, _vis_out_buffer); __CK break;
  switch( size ) {
    __I_CASE(16)
    __I_CASE(32)
    __I_CASE(64)
