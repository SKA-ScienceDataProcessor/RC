...
normalizeAndExtractPolarization pol polp (Grid _ gridp) =
  -- 128 * 32 = 4096
  CUDA.launchKernel normalizeAndExtractPolarization_c (128, 128, 1) (32, 32, 1) 0 Nothing $ mapArgs polp gridp (fromIntegral pol :: Int32)
          ...
          if doMe
            then do
              ...
              CUDA.launchKernel fun (16,16, 1) (8,8,1) 0 Nothing
                $ mapArgs pre_data_in vis_data_in (getLayers gcf) gridptr up vp len
              --
