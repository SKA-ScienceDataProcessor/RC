...
mkdir -p $HOME/.dflogs/$SLURM_JOB_ID

mkdir -p $HOME/.dflogs/$SLURM_JOB_ID/logs
mkdir -p $HOME/.dflogs/$SLURM_JOB_ID/profile

#CMD="mpirun -ppn $mpi_tasks_per_node -np $np $application $options"
CMD="srun -n $np --error=$HOME/.dflogs/$SLURM_JOB_ID/logs/node-%n-task-%t --output=$HOME/.dflogs/$SLURM_JOB_ID/logs/node-%n-task-%t $SDP_LAUNCH_COMMAND $SDP_LAUNCH_ARGUMENTS"
